package com.pujaad.coopmart.ui
...
import com.pujaad.coopmart.analyzer.MLKitBarcodeAnalyzer
import com.pujaad.coopmart.analyzer.ScanningResultListener
import com.pujaad.coopmart.api.common.Constant
import com.pujaad.coopmart.databinding.ActivityBarcodeScanningBinding
...
class BarcodeScanningActivity : AppCompatActivity() {
    ...
    private val viewModel: InventoryViewModel by viewModels { InventoryViewModel.Factory(application) }
    ...
    private lateinit var loading: ProgressDialog//default is MLKit
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.observableProduct.observe(this) {
            ...
            supportFragmentManager.setFragmentResult(InventoryScannerFragment.REQUEST_KEY, bundle)
            ...
            override fun onScanned(result: String) {
                runOnUiThread {
                    ...
                    try {
                        ...
                        val qrData = Pair(qrDataArr[0].toInt(), qrDataArr[1])
                        viewModel.getInventoryById(qrData.second.toInt())
                    } catch (e: Exception) {
                        Toast.makeText(applicationContext, "Invalid QR code detected", Toast.LENGTH_SHORT).show()
                        e.printStackTrace()
                    }
                }
            }
