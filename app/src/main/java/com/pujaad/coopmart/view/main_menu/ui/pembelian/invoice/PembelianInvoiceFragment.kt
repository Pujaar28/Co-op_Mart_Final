...
import com.pujaad.coopmart.databinding.FragmentPembelianInvoiceBinding
...
class PembelianInvoiceFragment : BaseFragment(R.layout.fragment_pembelian_invoice) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Printooth.init(this@PembelianInvoiceFragment.requireContext())
    ...
    private fun saveAsImage() {
        try {
            ...
            whiteBitmap.compress(Bitmap.CompressFormat.PNG, 10, ostream)
            ostream.close()
        ...
        binding!!.btnPrint.setOnClickListener {
            ...
            if (!Printooth.hasPairedPrinter())
                resultLauncher.launch(
                    Intent(
                        this@PembelianInvoiceFragment.requireContext(),
    ...
    private fun getSomePrintables() = ArrayList<Printable>().apply {
        ...
        add(
            TextPrintable.Builder()
                .setText("Username:   "+binding.tvInvoiceUser.text.toString())
                .setAlignment(DefaultPrinter.ALIGNMENT_LEFT)
                .setFontSize(DefaultPrinter.FONT_SIZE_NORMAL)
                .setNewLinesAfter(1)
                .build()
        ...
        items?.forEach { item ->
            ...
            val itemPrice = item.product?.buyPrice?.toIDRFormat()
